...
#    outfile_directory = r"I:\Melanoma_2018_Nuc_Project\wgENCODE_histone_mod_nuc_Tallies"
    outfile_directory = r"I:\Melanoma_2018_Nuc_Project\roadmap_histone_mod_nuc_Tallies"
    ...
    outfile = open(outfile_directory + "\\" + outfile_prefix + "_" + outfile_suffix + "_Strong_Dyad_Mutation_And_Dinuc_Tallies_p0.01.txt", "w")
    stable_away(chr_dict, dyad_dict, mut_tally_dict, dinuc_tally_dict, number_of_intervals, outfile, trinuc_freq_dict)

def saddle_up():
#    dyad_directory = r"I:\Melanoma_2018_Nuc_Project\wgENCODE_histone_mod_sorted_Nucleosomes"
    dyad_directory = r"I:\Melanoma_2018_Nuc_Project\roadmap_histone_mod_sorted_Nucleosomes_p0.01"
...
#    different_horse(acral_mut_files, dyad_dict, chr_dict)
