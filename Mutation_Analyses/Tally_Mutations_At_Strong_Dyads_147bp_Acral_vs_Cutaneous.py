...
def different_horse(mut_files, dyad_dict, chr_dict):
    ...
    type_prefix = example_file[directory_index+1 : fourth_underscore_index]
    outfile = open(type_prefix + "_Strong_Dyad_Mutation_And_Dinuc_Tallies.txt", "w")

    trinuc_file = type_prefix + "_simple_All_Trinuc_Tallies.txt"
