...
def different_horse(mut_files, dyad_dict, chr_dict, dyad_file):
    ...
    outfile = open(outfile_directory + "\\" + outfile_prefix + "_" + outfile_suffix + "_Strong_Dyad_TS_Mutation_And_Dinuc_Tallies.txt", "w")
...
def saddle_up():
    ...
    cC_mut_file = r"I:\Melanoma_2018_Nuc_Project\TS_and_NTS_Mutations\Cutaneous_High_CCDS_Mutations_TS.txt"
