...
def different_horse(mut_files, dyad_dict, chr_dict):
    ...
    outfile = open(example_file[directory_index+1 : fourth_underscore_index] + "_Weak_Dyad_Mutation_And_Dinuc_Tallies.txt", "w")
...
def saddle_up():
    dyad_file = r"I:\Melanoma\Nucleosomes\2018_3_8_new_117bp_sorted_With_Start_Crd_Fix\nuc-5to-40_allchr_hg19_1based_117bp_notBLIST_final_2.txt"
    ...
    different_horse(mut_files, dyad_dict, chr_dict)
