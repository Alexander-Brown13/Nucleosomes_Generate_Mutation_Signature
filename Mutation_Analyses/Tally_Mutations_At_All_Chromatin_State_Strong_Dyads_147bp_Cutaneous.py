...
def different_horse(mut_files, dyad_dict, chr_dict, dyad_file):
    ...
    outfile_directory = r"I:\Melanoma_2018_Nuc_Project\Chromatin_States\Chromatin_State_Nucleosome_Mut_Tallies"
    ...
    outfile = open(outfile_directory + "\\" + outfile_prefix + "_" + outfile_suffix + "_Strong_Dyad_Mutation_And_Dinuc_Tallies.txt", "w")
    stable_away(chr_dict, dyad_dict, mut_tally_dict, dinuc_tally_dict, number_of_intervals, outfile, trinuc_freq_dict)

def saddle_up():
    dyad_directory = r"I:\Melanoma_2018_Nuc_Project\Chromatin_States\Chromatin_State_Sorted_Nucleosomes"
