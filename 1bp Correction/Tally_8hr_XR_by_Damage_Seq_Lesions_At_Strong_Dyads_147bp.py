...
def different_horse(mut_files, dyad_dict):
    ...
    outfile_name = example_file[directory_index_1+1 : directory_index_2] + "_Strong_Dyad_4hr_XR_Lesions_Tallies.txt"
...
def saddle_up():
    ...
    file_0hr_by_80J = r"I:\Melanoma_Fixing_1bp_Error\1hr_XR_by_Damage_Seq_Strong_Dyad_Lesions_And_Dinuc_Tallies.txt"

    tally_dict_1hr_XR = different_horse(files_1hr_XR, dyad_dict)

    tally_dict_80J = get_80J_tally_dict(file_0hr_by_80J)

    outfile = open("8hr_XR_by_Damage_Seq_Strong_Dyad_Lesions_And_Dinuc_Tallies.txt", "w")
