...
def saddle_up(dyad_file):
    files_1hr_XR = get_file_list(r"I:\Melanoma_Fixing_1bp_Error\XRseq\BEDs\8hr")
    ...
    outfile_directory = r"I:\Melanoma_Fixing_1bp_Error\XRseq\8hr\Transcript_Nucleosome_Tallies"
    ...
    outfile = open(outfile_directory + "\\" + outfile_suffix + "_8hr_XR_by_Damage_Seq_Strong_Dyad_Lesion_Tallies.txt", "w")
    header = '\t'.join(["Bin", "8hr_XR_Lesion_Tally", "DMG_Lesion_Tally", "8hr_XR_by_DMG_Tally"])
