...
#    chr_dict = generate_chr_dict()
    ...
    files_0hr = get_file_list(r"I:\Melanoma_Fixing_1bp_Error\HS_DMGseq\BEDs\0hr")
    files_80J = get_file_list(r"I:\Melanoma_Fixing_1bp_Error\HS_DMGseq\BEDs\20J")
    ...
    outfile = open("0hr_by_20J_Strong_Dyad_HS_DMG_Lesions_And_Dinuc_Tallies_Both_Pos.txt", "w")
