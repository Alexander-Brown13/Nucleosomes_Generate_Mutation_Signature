...
def saddle_up(dyad_file):
    ...
    outfile_directory = r"I:\Melanoma_Fixing_1bp_Error\XRseq\roadmap_histone_mod_nuc_Tallies"
    ...
    outfile = open(outfile_directory + "\\" + outfile_suffix + "_1hr_XR_by_Damage_Seq_Modified_Strong_Dyad_Lesion_Tallies.txt", "w")
