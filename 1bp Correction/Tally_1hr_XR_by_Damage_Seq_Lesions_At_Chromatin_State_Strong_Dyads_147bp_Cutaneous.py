...
def saddle_up(dyad_file):
    files_1hr_XR = get_file_list(r"I:\Melanoma_Fixing_1bp_Error\XRseq\BEDs\1hr")
    files_naked_DMG_Seq = get_file_list(r"I:\Melanoma_Fixing_1bp_Error\HS_DMGseq\BEDs\20J")
    ...
    outfile_directory = r"I:\Melanoma_Fixing_1bp_Error\XRseq\Chromatin_State_Nucleosome_Lesion_Tallies"
    ...
    outfile = open(outfile_directory + "\\" + outfile_suffix + "_1hr_XR_by_Damage_Seq_Chromatin_State_Strong_Dyad_Lesion_Tallies.txt", "w")
