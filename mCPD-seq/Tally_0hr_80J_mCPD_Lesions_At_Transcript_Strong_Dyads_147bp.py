...
def saddle_up(dyad_file):
    files_0hr = get_file_list(r"I:\Melanoma\Wyrick_Lesions\0hr_C_sorted_BEDs")
    files_80J = get_file_list(r"I:\Melanoma\Wyrick_Lesions\80J_C_sorted_BEDs")
    ...
    outfile_directory = r"I:\Melanoma_2018_Nuc_Project\Lesions_mCPDs\Transcript_Nucleosome_Tallies"
    ...
    outfile = open(outfile_directory + "\\" + outfile_suffix + "mCPD_0hr_by_80J_Strong_Dyad_Lesions_And_Dinuc_Tallies.txt", "w")
