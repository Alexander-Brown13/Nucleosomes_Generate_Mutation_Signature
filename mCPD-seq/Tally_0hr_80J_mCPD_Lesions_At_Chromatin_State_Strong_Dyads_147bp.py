...
def saddle_up(dyad_file):
    files_0hr = get_file_list(r"I:\Melanoma\Wyrick_Lesions\0hr_All_Black_List_BEDs")
    files_80J = get_file_list(r"I:\Melanoma\Wyrick_Lesions\80J_All_Black_List_BEDs")

    outfile_directory = r"I:\Melanoma_2018_Nuc_Project\Lesions\Chromatin_State_Nucleosome_Lesion_Tallies"
    ...
    outfile = open(outfile_directory + "\\" + outfile_suffix + "_0hr_by_80J_Chromatin_State_Strong_Dyad_Lesion_Tallies.txt", "w")
