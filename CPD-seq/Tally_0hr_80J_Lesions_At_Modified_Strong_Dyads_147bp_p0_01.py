...
def saddle_up(dyad_file):
    ...
    outfile_directory = r"I:\Melanoma_2018_Nuc_Project\Lesions\roadmap_histone_mod_nuc_Tallies"
    ...
    outfile = open(outfile_directory + "\\" + outfile_suffix + "_0hr_by_80J_Modified_Strong_Dyad_Lesions_And_Dinuc_Tallies.txt", "w")
